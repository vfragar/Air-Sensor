...
# HTML to see the WBGT value in realtime
...
# HTML to save the desired values into the flash memory
...
# you can choose to set the sensor either as wifi device or a wifi ap
# wifi device to work as a normal electronic device connected to a wifi access point
# or wifi access point to create a webserver with a html self hosted dashboard to configure everything in the sensor itself (communication protocol, wifi ssid and pass, etc)
